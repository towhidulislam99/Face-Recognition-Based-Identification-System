...
urlpatterns = [
    ...
    path('facerecognision/', views.Geobag, name = 'Geobag'),
    ...
    path('facerecognitionvideopage/', views.facerecognitionvideopage, name='facerecognitionvideopage'),
    path('facerecognitionvideoinsert/', views.facerecognitionvideoinsert, name='facerecognitionvideoinsert'),
    path('facerecognitionvideodatatable/', views.facerecognitionvideodatatable, name='facerecognitionvideodatatable'),
    path('facerecognitionvideoedit/<int:id>', views.facerecognitionvideoedit, name='facerecognitionvideoedit'),
    path('facerecognitionvideoupdate/', views.facerecognitionvideoupdate, name='facerecognitionvideoupdate'),
    path('deletefacerecognitionvideo/<int:id>', views.deletefacerecognitionvideo, name='deletefacerecognitionvideo'),
